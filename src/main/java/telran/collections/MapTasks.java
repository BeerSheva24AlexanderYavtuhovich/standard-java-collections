...
public class MapTasks {
    public static void displayOccurrences(String[] strings) {
        ...
        TreeMap<Long, TreeSet<String>> sortedOccurencesMap = getSortedOcurrencesMap(occurrencesMap);
        displaySortedOccurrencesMap(sortedOccurencesMap);
    }

    private static void displaySortedOccurrencesMap(TreeMap<Long, TreeSet<String>> sortedOccurencesMap) {
        sortedOccurencesMap.forEach(
                (occurrency, treeSet) -> treeSet.forEach(s -> System.out.printf("%s -> %d \n", s, occurrency)));

    }

    private static TreeMap<Long, TreeSet<String>> getSortedOcurrencesMap(HashMap<String, Long> occurrencesMap) {
